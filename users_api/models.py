...
class AnnouncementTbl(models.Model):
...
class FeedbackResponseTbl(models.Model):
    id = models.BigAutoField(primary_key=True)
    rating = models.CharField(max_length=20)
    feedback = models.ForeignKey('FeedbackTbl', models.DO_NOTHING)
    question = models.ForeignKey('QuestionTbl', models.DO_NOTHING)
...
class NavigationTbl(models.Model):
...
class TokenBlacklistOutstandingtoken(models.Model):
    ...
    user = models.ForeignKey('UserAccountTbl', models.DO_NOTHING, blank=True, null=True)
...
class UserAccountTbl(models.Model):
